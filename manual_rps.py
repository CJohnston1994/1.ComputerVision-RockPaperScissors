...
def get_Winner(frame, user_Choice, computer_Choice, score):
    if user_Choice == computer_Choice:
        img = cv2.putText(frame, f"You both picked {user_Choice}", (20, 300), font, 1, color, 1, cvline)
        return [score[0]+1,score[1]+1]
    elif user_Choice == 'Rock' and computer_Choice == 'Paper':
        img = cv2.putText(frame, "Opponent picked {computer_Choice}! You Lose... Try Again!", (20, 300), font, 1, color, 2, cvline)
